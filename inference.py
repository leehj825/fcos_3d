...
#default_load_checkpoint = 'save_state_kitti_5.bin'
default_load_checkpoint = 'save_state_waymo_1.bin'
#default_load_checkpoint = None

#default_output_image_path = 'output_kitti_5'
default_output_image_path = 'output_waymo_1'
num_images = 10
...
def main(mode='inference', dataset_name='waymo', image_path=None, load=None):
    ...
    if mode == 'inference':
        ...
        processed_images = 0
        for batch_idx, (images, _, _, image_paths)in enumerate(data_loader):  # Assuming calibration data is not needed for inference
