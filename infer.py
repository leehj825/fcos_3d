    ...
    if mode == 'inference':
        ...
        for batch_idx, batch_data in enumerate(data_loader):
            ...
            for idx, image in enumerate(images):
                ...
                #print(detections)
                original_image_path = image_paths[0]
                save_combined_image(dataset_name, calib_data, boxes, scores, labels, dimensions, locations, rotations, depth, original_image_path, f"{default_output_image_path}/output_{batch_idx:03d}.png")
