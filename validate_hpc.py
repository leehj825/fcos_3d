...
default_load_checkpoint = 'save_state_kitti_new_depth_hpc_60.bin'
#default_load_checkpoint = 'save_state_waymo_new_depth_hpc_10.bin'
#default_load_checkpoint = 'save_state_waymo_40.bin'
#default_load_checkpoint = None

default_output_image_path = 'output_kitti_new_depth_hpc_60'
#default_output_image_path = 'output_waymo_new_depth_hpc_10'
