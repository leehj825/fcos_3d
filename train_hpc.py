...
def main(mode='train', dataset_name='waymo', image_path=None, load=None):
    ...
    #optimizer = torch.optim.Adam(params, lr=default_learning_rate, weight_decay=0.0005)
        ...
        for epoch in range(start_epoch, num_epochs):
            ...
            for batch_idx, batch_data in enumerate(data_loader):
                ...
                for image_targets in targets:
                    ...
                    location_xy = []  # 3D bounding box center location (x, y, z)
                    ...
                    if boxes:
                        target_dict = {
                            ...
                            'location_xy': torch.tensor(location_xy, dtype=torch.float32).to(device),
